...
public class AppsCustomizeTabHost extends LauncherRootView implements LauncherTransitionable, Insettable  {
    ...
    private  AppsCustomizePagedView.ContentType mContentType;
    ...
    public AppsCustomizePagedView.ContentType getContentType(){
        return mContentType;
    }
    ...
    protected void onFinishInflate() {
        ...
        mDrawer = (ApplicationDrawer) findViewById(R.id.application_drawer);
    ...
    public void onWindowVisible() {
        if (getVisibility() == VISIBLE) {
            ...
            mDrawer.loadAssociatedPages(mDrawer.getCurrentPage(), true);
            mDrawer.loadAssociatedPages(mDrawer.getCurrentPage());
            if(mContentType == AppsCustomizePagedView.ContentType.Widgets){
                mPagedView.setVisibility(VISIBLE);
            }else{
    ...
    public void onLauncherTransitionPrepare(Launcher l, boolean animated, boolean toWorkspace) {
        ...
        mDrawer.onLauncherTransitionPrepare(l, animated, toWorkspace);
        mInTransition = true;
    ...
    public void onLauncherTransitionStart(Launcher l, boolean animated, boolean toWorkspace) {
        ...
        mDrawer.onLauncherTransitionStart(l, animated, toWorkspace);
    }

    @Override
    public void onLauncherTransitionStep(Launcher l, float t) {
        mPagedView.onLauncherTransitionStep(l, t);
        mDrawer.onLauncherTransitionStep(l, t);
    }

    @Override
    public void onLauncherTransitionEnd(Launcher l, boolean animated, boolean toWorkspace) {
        mPagedView.onLauncherTransitionEnd(l, animated, toWorkspace);
        mDrawer.onLauncherTransitionEnd(l, animated, toWorkspace);
        mInTransition = false;
