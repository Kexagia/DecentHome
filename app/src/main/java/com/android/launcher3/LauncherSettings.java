...
class LauncherSettings {
    ...
    static final class DrawerScreens implements ChangeLogColumns {
        /**
         * The content:// style URL for this table
         */
        static final Uri CONTENT_URI = Uri.parse("content://" +
                LauncherProvider.AUTHORITY + "/" + LauncherProvider.TABLE_DRAWER_SCREENS +
                "?" + LauncherProvider.PARAMETER_NOTIFY + "=true");
    ...
    static final class DrawerItems implements BaseLauncherColumns {
        /**
         * The content:// style URL for this table
         */
        static final Uri CONTENT_URI = Uri.parse("content://" +
                LauncherProvider.AUTHORITY + "/" + LauncherProvider.TABLE_DRAWER +
                "?" + LauncherProvider.PARAMETER_NOTIFY + "=true");
         ...
         */
        static final Uri OLD_CONTENT_URI = Uri.parse("content://" +
                LauncherProvider.OLD_AUTHORITY + "/" + LauncherProvider.TABLE_DRAWER +
                "?" + LauncherProvider.PARAMETER_NOTIFY + "=true");
        ...
        static Uri getContentUri(long id, boolean notify) {
            return Uri.parse("content://" + LauncherProvider.AUTHORITY +
                    "/" + LauncherProvider.TABLE_DRAWER + "/" + id + "?" +
                    LauncherProvider.PARAMETER_NOTIFY + "=" + notify);
        }
        ...
        static final String containerToString(int container) {
            switch (container) {
                case CONTAINER_DRAWER: return "drawer";
                default: return String.valueOf(container);
            }
        }
