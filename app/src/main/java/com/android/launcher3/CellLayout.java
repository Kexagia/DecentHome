...
public class CellLayout extends ViewGroup {
    ...
    public boolean addViewToCellLayout(View child, int index, int childId, LayoutParams params,
        ...
        mHideIconLabels = SettingsProvider.getBoolean(getContext(),
    ...
    public void completeAndClearReorderPreviewAnimations() {
    ...
    private void commitTempPlacement() {
        ...
        if(mLauncher.getState() == Launcher.State.WORKSPACE) {
            mLauncher.getWorkspace().updateItemLocationsInDatabase(this);
        }else{
            mLauncher.getDrawer().updateItemLocationsInDatabase(this);
        }
    }
