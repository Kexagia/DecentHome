...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    protected static final int OVER_SCROLL_PAGE_SNAP_ANIMATION_DURATION = 150;
    protected static final int SLOW_PAGE_SNAP_ANIMATION_DURATION = 650;
    ...
    private static final int MIN_SNAP_VELOCITY = 1900;
