...
public class DeviceProfile {
    ...
    public void layout(Launcher launcher) {
        ...
        if (pageIndicator != null) {
            if (hasVerticalBarLayout) {
                ...
                lp.height = LayoutParams.WRAP_CONTENT;
                lp.bottomMargin = hotseatBarHeightPx - 30;
        ...
        if (host != null) {
            orientation = isLandscape ? CellLayout.LANDSCAPE : CellLayout.PORTRAIT;
            padding = getWorkspacePadding(orientation);
            host.setPadding(0, padding.top, 0, 0);
            ...
            if (pageIndicator != null) {
                ...
                lp.width = LayoutParams.WRAP_CONTENT;
                lp.height = LayoutParams.WRAP_CONTENT;
                lp.bottomMargin = heightPx - availableHeightPx - pageIndicatorHeightPx;
                pageIndicator.setLayoutParams(lp);
            }

            pageIndicator = host.findViewById(R.id.drawer_page_indicator);
            if (pageIndicator != null) {
                lp = (FrameLayout.LayoutParams) pageIndicator.getLayoutParams();
                lp.gravity = Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM;
                lp.width = LayoutParams.WRAP_CONTENT;
            ...
            if (pagedView != null) {
                ...
                pagedView.setWidgetsPageIndicatorPadding(0);
                ...
                pagedView.setPadding(padding.left, 0,
                        padding.right, heightPx - availableHeightPx - 5);
                fakePageContainer.setPadding(padding.left, searchBarSpaceHeightPx + 25,
                        padding.right, heightPx - availableHeightPx - 5);

            }

            ApplicationDrawer drawer = (ApplicationDrawer)
                    host.findViewById(R.id.application_drawer);
            ...
            if (drawer != null) {
                ...
                drawer.setPadding(padding.left, padding.top, padding.right, padding.bottom);*/

                /*FrameLayout.LayoutParams dlp = (FrameLayout.LayoutParams) drawer.getLayoutParams();
                dlp.gravity = Gravity.BOTTOM;
                dlp.width = LayoutParams.MATCH_PARENT;
                dlp.height = LayoutParams.MATCH_PARENT;
                drawer.setLayoutParams(dlp);
                padding = getWorkspacePadding(orientation);
                drawer.setPadding(padding.left, searchBarSpaceHeightPx, padding.right,
                        heightPx - availableHeightPx - 5);*/
                ...
                drawer.setPadding(padding.left, searchBarSpaceHeightPx, padding.right, padding.bottom - hotseatBarHeightPx);
                drawer.setPageSpacing(getWorkspacePageSpacing(orientation));
    ...
    public void realignPageIndicator(Launcher launcher){
        View pageIndicator = launcher.findViewById(R.id.page_indicator);
        boolean hasVerticalBarLayout = isVerticalBarLayout();
        // Layout the workspace
        if (pageIndicator != null) {
            if (hasVerticalBarLayout) {
                ...
                lp.width = LayoutParams.WRAP_CONTENT;
                lp.height = LayoutParams.WRAP_CONTENT;
                lp.bottomMargin = hotseatBarHeightPx + 55;
                pageIndicator.setLayoutParams(lp);
            }
        }
    }
